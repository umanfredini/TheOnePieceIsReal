...
<main class="container mt-5" role="main">
    ...
    <section class="mb-4" role="region" aria-label="Aggiorna stato ordine">
        <form action="UpdateOrderStatusServlet" method="post" class="card p-3">
            ...
            <div class="mb-3">
                ...
                <select name="status" id="status" class="form-select">
                    ...
                    <option value="processing" <c:if test="${order.status == 'processing'}">selected</c:if>>In lavorazione</option>
