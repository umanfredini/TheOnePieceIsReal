...
<main class="container mt-5" role="main">
    <div class="row">
        <div class="col-md-6">
            <img src="${pageContext.request.contextPath}/styles/images/prodotti/${product.imageUrl}" alt="Immagine di ${product.name}" class="img-fluid rounded shadow-sm" />
        </div>
        <div class="col-md-6">
            ...
            <form action="${pageContext.request.contextPath}/CartServlet" method="post" class="mt-4">
