                            ...
                            <c:forEach var="character" items="${characters}">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" 
                                           ...
                                           name="characters" 
                                           value="${character}"
                                           <c:if test="${paramValues.characters != null && fn:contains(paramValues.characters, character)}">checked</c:if>>
                                    <label class="form-check-label" for="char_${character}">
                                        ${character}
                                    </label>
                                </div>
                            </c:forEach>
                                        ...
                                        <div class="product-card">
                                            <div class="product-image">
                                                ...
                                                <div class="product-overlay">
                                                    <div class="product-actions">
                                                        ...
                                                        <a href="${pageContext.request.contextPath}/ProductServlet?action=detail&id=${product.id}" class="btn btn-sm btn-outline-secondary">
                                            ...
                                            <div class="product-info">
                                                <h5 class="product-title">
                                                    <a href="ProductServlet?action=detail&id=${product.id}">${product.name}</a>
                                                </h5>
                        ...
                        <c:otherwise>
                            <div class="no-products">
                                <div class="text-center py-5">
                                    ...
                                    <a href="catalog" class="btn btn-primary">Torna al catalogo</a>
                                </div>
                            </div>
                        </c:otherwise>
                    </c:choose>
